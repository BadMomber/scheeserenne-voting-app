module.exports = {
  ...
  deploy: {
    production: {
      ...
      "post-deploy":
        "npm --prefix server install && npm --prefix client install && npm --prefix server run migrate && npm --prefix client run build && pm2 reload ecosystem.config.js --env production",
      env: {
        NODE_ENV: "production",
