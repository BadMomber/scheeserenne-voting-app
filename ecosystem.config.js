module.exports = {
  ...
  deploy: {
    production: {
      ...
      "post-deploy":
        "whoami && which npm && npm --prefix server install && npm --prefix client install && npm --prefix server run migrate && npm --prefix client run build && pm2 reload ecosystem.config.js --env production && pm2 restart all",
      env: {
        NODE_ENV: "production",
        DATABASE_URL: "postgres://root:kk86227KR@localhost:5432/sva",
      },
